 ...
 */
public class DefaultCrossfader {
    /**
     ...
     * @return
     */
    public DefaultCrossfader withContent(View content) {
     ...
     * @return
     */
    public DefaultCrossfader withFirst(View first, int width) {
        this.mFirst = first;
     ...
     * @return
     */
    public DefaultCrossfader withSecond(View first, int width) {
        this.mSecond = first;
     ...
     * @return
     */
    public DefaultCrossfader withStructure(View first, int firstWidth, View second, int secondWidth) {
     ...
     * @return
     */
    public DefaultCrossfader withSavedInstance(Bundle savedInstance) {
     ...
     * @return
     */
    public DefaultCrossfader withCanSlide(boolean canSlide) {
     ...
     * @return
     */
    public DefaultCrossfader withPanelSlideListener(SlidingPaneLayout.PanelSlideListener panelSlideListener) {
     ...
     * @return
     */
    public DefaultCrossfader withResizeContentPanel(boolean resizeContentPanel) {
     ...
     * @return
     */
    public DefaultCrossfader build() {
